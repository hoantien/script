...
# Stream on
adb shell "echo 7 0x0002 0x02 0x00 0x00 0x11 0x00 0x00 > /sys/class/light_ccb/i2c_interface/i2c_w"
sleep 1
adb shell "echo 7 0x0002 0x20 0x00 0x00 0x11 0x00 0x00 > /sys/class/light_ccb/i2c_interface/i2c_w"
sleep 1
